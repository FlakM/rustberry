...
pub struct SoilHumidityReading {
    pub humidity: f32,
}
...
const MAX: f32 = 100_f32;
const MIN: f32 = 0_f32;

/// mcp3008 has 10bit precision so values in range 0 - 1023
/// but we need to normalize sensors by measuring max and min readings
/// it will return values from 0-100
pub fn normalize_mcp_readings(sensor_value: u16, sensor_calibration: &SoilSensorParams) -> f32 {
